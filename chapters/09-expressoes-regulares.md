...
ë possível escrever expressões expressões regulares que fazem muitos retrocessos. O Problema ocorre quando um paddrão encontra um pedaço da _string_ de entrada de muitas maneiras. Por exemplo, se confundimos e escrevemos nossa expre˜ão regular para achar binários e números assim /([01]+)+b/.
